...
namespace RealtimeSpreadMonitor
{
    ...
    partial void Inserttblportfoliogroup(tblportfoliogroup instance);
    partial void Updatetblportfoliogroup(tblportfoliogroup instance);
    partial void Deletetblportfoliogroup(tblportfoliogroup instance);
    partial void Inserttblportfolioinstrumentlist(tblportfolioinstrumentlist instance);
    partial void Updatetblportfolioinstrumentlist(tblportfolioinstrumentlist instance);
    partial void Deletetblportfolioinstrumentlist(tblportfolioinstrumentlist instance);
    partial void Inserttblexchange(tblexchange instance);
    partial void Updatetblexchange(tblexchange instance);
    partial void Deletetblexchange(tblexchange instance);
    partial void Inserttbloptionproperty(tbloptionproperty instance);
    partial void Updatetbloptionproperty(tbloptionproperty instance);
    partial void Deletetbloptionproperty(tbloptionproperty instance);
    #endregion
		
		public DataClassesTMLDBDataContext() : 
				base(global::RealtimeSpreadMonitor.Properties.Settings.Default.TMLDBConnectionString1, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<tblportfoliogroup> tblportfoliogroups
		{
			get
			{
				return this.GetTable<tblportfoliogroup>();
			}
		}
		
		public System.Data.Linq.Table<tblportfolioinstrumentlist> tblportfolioinstrumentlists
		{
			get
			{
				return this.GetTable<tblportfolioinstrumentlist>();
			}
		}
		
		public System.Data.Linq.Table<tblexchange> tblexchanges
		{
			get
			{
				return this.GetTable<tblexchange>();
			}
		}
		
		public System.Data.Linq.Table<tbloptionproperty> tbloptionproperties
		{
			get
			{
				return this.GetTable<tbloptionproperty>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="cqgdb.tblportfoliogroups")]
	public partial class tblportfoliogroup : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private long _idportfoliogroup;
		
		private string _portfolioname;
		
		private short _optionspreadgroup;
		
		private short _activegroup;
		
		private int _idportfolioinstrumentlist;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnidportfoliogroupChanging(long value);
    partial void OnidportfoliogroupChanged();
    partial void OnportfolionameChanging(string value);
    partial void OnportfolionameChanged();
    partial void OnoptionspreadgroupChanging(short value);
    partial void OnoptionspreadgroupChanged();
    partial void OnactivegroupChanging(short value);
    partial void OnactivegroupChanged();
    partial void OnidportfolioinstrumentlistChanging(int value);
    partial void OnidportfolioinstrumentlistChanged();
    #endregion
		
		public tblportfoliogroup()
		{
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idportfoliogroup", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public long idportfoliogroup
		{
			get
			{
				return this._idportfoliogroup;
			}
			set
			{
				if ((this._idportfoliogroup != value))
				{
					this.OnidportfoliogroupChanging(value);
					this.SendPropertyChanging();
					this._idportfoliogroup = value;
					this.SendPropertyChanged("idportfoliogroup");
					this.OnidportfoliogroupChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_portfolioname", DbType="VarChar(45) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_optionspreadgroup", DbType="SmallInt NOT NULL")]
		public short optionspreadgroup
		{
			get
			{
				return this._optionspreadgroup;
			}
			set
			{
				if ((this._optionspreadgroup != value))
				{
					this.OnoptionspreadgroupChanging(value);
					this.SendPropertyChanging();
					this._optionspreadgroup = value;
					this.SendPropertyChanged("optionspreadgroup");
					this.OnoptionspreadgroupChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_activegroup", DbType="SmallInt NOT NULL")]
		public short activegroup
		{
			get
			{
			...
			set
			{
				...
				{
					this.OnactivegroupChanging(value);
					this.SendPropertyChanging();
					this._activegroup = value;
					this.SendPropertyChanged("activegroup");
					this.OnactivegroupChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idportfolioinstrumentlist", DbType="Int NOT NULL")]
		public int idportfolioinstrumentlist
		{
			get
			{
				return this._idportfolioinstrumentlist;
			}
			set
			{
				if ((this._idportfolioinstrumentlist != value))
				{
					this.OnidportfolioinstrumentlistChanging(value);
					this.SendPropertyChanging();
					this._idportfolioinstrumentlist = value;
					this.SendPropertyChanged("idportfolioinstrumentlist");
					this.OnidportfolioinstrumentlistChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="cqgdb.tblportfolioinstrumentlist")]
	public partial class tblportfolioinstrumentlist : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _pkportfolioinstrumentlist;
		
		private int _idportfolioinstrumentlist;
		
		private int _idinstrument;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnpkportfolioinstrumentlistChanging(int value);
    partial void OnpkportfolioinstrumentlistChanged();
    partial void OnidportfolioinstrumentlistChanging(int value);
    partial void OnidportfolioinstrumentlistChanged();
    partial void OnidinstrumentChanging(int value);
    partial void OnidinstrumentChanged();
    #endregion
		
		public tblportfolioinstrumentlist()
		{
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_pkportfolioinstrumentlist", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int pkportfolioinstrumentlist
		{
			get
			{
				return this._pkportfolioinstrumentlist;
			}
			set
			{
				if ((this._pkportfolioinstrumentlist != value))
				{
					this.OnpkportfolioinstrumentlistChanging(value);
					this.SendPropertyChanging();
					this._pkportfolioinstrumentlist = value;
					this.SendPropertyChanged("pkportfolioinstrumentlist");
					this.OnpkportfolioinstrumentlistChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idinstrument", DbType="Int NOT NULL")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="cqgdb.tblexchange")]
	public partial class tblexchange : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _spanexchangesymbol;
		
		private string _spanExchWebAPISymbol;
		
		private string _tradingTechnologiesExchange;
		
		private string _tradingTechnologiesGateway;
    ...
    partial void OnspanexchangesymbolChanging(string value);
    partial void OnspanexchangesymbolChanged();
    partial void OnspanExchWebAPISymbolChanging(string value);
    partial void OnspanExchWebAPISymbolChanged();
    partial void OntradingTechnologiesExchangeChanging(string value);
    partial void OntradingTechnologiesExchangeChanged();
    partial void OntradingTechnologiesGatewayChanging(string value);
    partial void OntradingTechnologiesGatewayChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idexchange", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public long idexchange
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_exchange", DbType="VarChar(45) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_spanexchangesymbol", DbType="VarChar(5) NOT NULL", CanBeNull=false)]
		public string spanexchangesymbol
		{
			get
			{
				return this._spanexchangesymbol;
			}
			set
			{
				if ((this._spanexchangesymbol != value))
				{
					this.OnspanexchangesymbolChanging(value);
					this.SendPropertyChanging();
					this._spanexchangesymbol = value;
					this.SendPropertyChanged("spanexchangesymbol");
					this.OnspanexchangesymbolChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_spanExchWebAPISymbol", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string spanExchWebAPISymbol
		{
			get
			{
				return this._spanExchWebAPISymbol;
			}
			set
			{
				if ((this._spanExchWebAPISymbol != value))
				{
					this.OnspanExchWebAPISymbolChanging(value);
					this.SendPropertyChanging();
					this._spanExchWebAPISymbol = value;
					this.SendPropertyChanged("spanExchWebAPISymbol");
					this.OnspanExchWebAPISymbolChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_tradingTechnologiesExchange", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string tradingTechnologiesExchange
		{
			get
			{
				return this._tradingTechnologiesExchange;
			}
			set
			{
				if ((this._tradingTechnologiesExchange != value))
				{
					this.OntradingTechnologiesExchangeChanging(value);
					this.SendPropertyChanging();
					this._tradingTechnologiesExchange = value;
					this.SendPropertyChanged("tradingTechnologiesExchange");
					this.OntradingTechnologiesExchangeChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_tradingTechnologiesGateway", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string tradingTechnologiesGateway
		{
			get
			{
				return this._tradingTechnologiesGateway;
			}
			set
			{
				if ((this._tradingTechnologiesGateway != value))
				{
					this.OntradingTechnologiesGatewayChanging(value);
					this.SendPropertyChanging();
					this._tradingTechnologiesGateway = value;
					this.SendPropertyChanged("tradingTechnologiesGateway");
					this.OntradingTechnologiesGatewayChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="cqgdb.tbloptionproperties")]
	public partial class tbloptionproperty : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private long _idoptionproperties;
		
		private long _idinstrument;
		
		private byte _optionmonthint;
		
		private System.DateTime _expirationlasttradetime;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnidoptionpropertiesChanging(long value);
    partial void OnidoptionpropertiesChanged();
    partial void OnidinstrumentChanging(long value);
    partial void OnidinstrumentChanged();
    partial void OnoptionmonthintChanging(byte value);
    partial void OnoptionmonthintChanged();
    partial void OnexpirationlasttradetimeChanging(System.DateTime value);
    partial void OnexpirationlasttradetimeChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idoptionproperties", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public long idoptionproperties
		{
			get
			{
				return this._idoptionproperties;
			}
			set
			{
				if ((this._idoptionproperties != value))
				{
					this.OnidoptionpropertiesChanging(value);
					this.SendPropertyChanging();
					this._idoptionproperties = value;
					this.SendPropertyChanged("idoptionproperties");
					this.OnidoptionpropertiesChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_optionmonthint", DbType="TinyInt NOT NULL")]
		public byte optionmonthint
		{
			get
			{
				return this._optionmonthint;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_expirationlasttradetime", DbType="DateTime2 NOT NULL")]
		public System.DateTime expirationlasttradetime
		{
			get
			{
				return this._expirationlasttradetime;
			}
			set
			{
				if ((this._expirationlasttradetime != value))
				{
					this.OnexpirationlasttradetimeChanging(value);
					this.SendPropertyChanging();
					this._expirationlasttradetime = value;
					this.SendPropertyChanged("expirationlasttradetime");
					this.OnexpirationlasttradetimeChanged();
				}
			}
		}
